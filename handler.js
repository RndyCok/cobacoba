...
function _0x1f1f() {
	const _0x437a74 = ['fsizedoc', 'sgc', 'ddocx', '\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20「\x20ᴡ\x20ᴇ\x20ʟ\x20ᴄ\x20ᴏ\x20ᴍ\x20ᴇ\x20」', '.owner', 'pdf', 'titlebot', '20hbclWI', '🌹Hallo', 'buffer', 'add', '264990qPCUgh', '1FJySAV', '🌺Author Bot', '21472385sSWBcX', '338802lIWcAV', '🎐Menu', '398673ExmgPg', '12nIokkC', '20eprFXu', '5195876jzJEuN', '550904LCnCzX', 'salken', '30495rpFhhV', '\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20「\x20ɢ\x20ᴏ\x20ᴏ\x20ᴅ\x20\x20ʙ\x20ʏ\x20ᴇ」', '.menu', 'sendMessage', '24PAoNmt', 'sig'];
	_0x1f1f = function() {
		return _0x437a74;
	};
	return _0x1f1f();
...
let buttonMessage = {
	...
	'fileName': action == _0x3332b6(0x1dc) ? _0x3332b6(0x1d5) : _0x3332b6(0x1cd),
	...
	'buttons': [{
		...
		'buttonText': {
			'displayText': _0x3332b6(0x1c5)
		},
		'type': 0x1
	}, {
		'buttonId': _0x3332b6(0x1d6),
		'buttonText': {
			'displayText': _0x3332b6(0x1c2)
		},
		'type': 0x1
	}, {
		'buttonId': _0x3332b6(0x1cb),
		'buttonText': {
			'displayText': _0x3332b6(0x1da)
		},
		'type': 0x1
	}],
	'headerType': 0x6
...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: '𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥 𝗢𝗡𝗟𝗬',
        owner: '𝗢𝗪𝗡𝗘𝗥 𝗢𝗡𝗟𝗬',
        mods: '𝗢𝗡𝗟𝗬 𝗠𝗢𝗗𝗘𝗥𝗔𝗧𝗘',
        premium: '𝗣𝗥𝗘𝗠𝗜𝗨𝗠 𝗢𝗡𝗟𝗬',
        group: '𝗚𝗥𝗢𝗨𝗣 𝗢𝗡𝗟𝗬',
        private: '𝗣𝗥𝗜𝗩𝗔𝗧𝗘 𝗢𝗡𝗟𝗬',
        admin: '𝗔𝗗𝗠𝗜𝗡 𝗢𝗡𝗟𝗬',
        botAdmin: '𝗕𝗢𝗧 𝗛𝗔𝗥𝗨𝗦 𝗠𝗘𝗡𝗝𝗔𝗗𝗜 𝗔𝗗𝗠𝗜𝗡',
        restrict: '𝗥𝗘𝗦𝗧𝗥𝗜𝗖𝗧 𝗢𝗙𝗙',
    }[type]
...
sourceUrl: swb
    ...
    let msgg = {
    	unreg: '*Upsss...*\nTerjadi kesalahan\n\nAnda perlu mendaftar ke Data akses Bot.'
}[type]
if (msgg) return conn.sendButton(m.chat, `${global.htki} VERIFY ${global.htka}`, msgg, null, [['  ͜͡  VERIFY', '/verify']],[['𝍤 ABAIKAN', '/abaikan']],m)
}
